...
export async function listCalendarEvents(params: CalendarEventListParams): Promise<CalendarEventInfo[]> {
  let { canvasBaseUrl, accessToken, courseId, courseName, startDate, endDate, type = 'event' } = params;
