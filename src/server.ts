    ...
    return {
      tools: [
        ...
        },
        {
          name: "smart_search",
          description:
            "Intelligently search for assignments, homework, files, or content using natural language. Can find homework assignments and their files automatically.",
          inputSchema: {
            type: "object",
            properties: {
              query: {
        ...
        case "smart_search": {
          ...
          if (courseName && assignmentName) {
            try {
              ...
              throw new Error(
                `Could not find homework: ${error instanceof Error ? error.message : "Unknown error"}`,
              );
            }
          }
