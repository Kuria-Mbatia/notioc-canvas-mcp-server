...
describe("search", () => {
  describe("findBestMatch", () => {
    ...
    test("should search across multiple keys", () => {
      const result = findBestMatch("neural", testItems, [
        "name",
        "description",
      ]);
    ...
    test("should prioritize better matches", () => {
      ...
      const result = findBestMatch("Programming", itemsWithSimilarNames, [
        "name",
      ]);
    ...
    test("should work with nested object keys", () => {
      ...
      const result = findBestMatch("Nested", itemsWithNested, [
        "details.title",
      ]);
